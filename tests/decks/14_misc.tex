...
\title{Miscellaneous}
\author{Test Author}
\logo{\includegraphics[height=0.6cm]{plot.png}}
...
\begin{frame}{Hyphenation}
  % Words broken at line ends: PDFium's text page reports each such hyphen as U+0002.
  \parbox{4.3cm}{Justified paragraphs hyphenate: extraordinarily incomprehensible
    characteristics of typesetting in narrow columns, demonstrably.}
\end{frame}
