...
#  "Both-moved geometry"; layout-stranded-formula passes since refit puts formula pictures over their
#  holes in the words as written: "Merged text into recreated boxes")
XFAIL.update({
})
